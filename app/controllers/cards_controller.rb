...
class CardsController < ApplicationController
  ...
  def card_params
    params.require(:card).permit(:company_id, :name, :kana_name, :department, :position, :postcode, :address, :building, :tel, :fax, :mail, :front_image, :back_image, :qualification, :note)
  end
end
